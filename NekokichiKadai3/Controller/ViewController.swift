...
final class ViewController: UIViewController {
    ...
    @IBAction func displayCalculatedResult(_ sender: UIButton) {
        ...
        // パターンマッチを使ってみたかった
        // 引数に余計なものを渡したくなかった
        calculateAdditionModel.input(
            num1: num1,
            isSwitch1On: signOfNum1Switch.isOn,
            num2: num2,
            isSwitch2On: signOfNum2Switch.isOn
        )
//        if case signOfNum1Switch.isOn = true {
//            calculateAdditionModel.setNum1(-num1)
//        } else {
//            calculateAdditionModel.setNum1(num1)
//        }
//        if case signOfNum2Switch.isOn = true {
